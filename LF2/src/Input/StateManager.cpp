...
void StateManager::TryStateChange(PlayerStates state, const double lastPressed, const int data) { //called when we try to change state by our input
...
void StateManager::ForceStateChange(PlayerStates state, const int data) {
